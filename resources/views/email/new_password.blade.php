...
<div class="new_password transition-all max-h-[93%] duration-300 overflow-auto max-w-[450px] fixed top-1/2 right-1/2 -translate-y-1/2 translate-x-1/2 px-[40px] w-full cus-bg rounded-[20px] flex flex-col justify-start items-center py-5">
    <a href="/"
    ...
    <h1 class="text-black mt-1.5 font-bold text-[26px]">رمز جدیدتو انتخاب کن</h1>
    <p class="text-[15px] text-gray-500 text-center">حواست باشه اشتباه نزنی!</p>
    <form action="" onclick="return false;" class="w-full" autocomplete="off">
        <div class="input-box w-full mt-1.5">
            <label for="email_forgot" class="text-[#FF5C00] font-bold">رمز عبور جدید :</label>
            <br>
