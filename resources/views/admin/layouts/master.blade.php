...
<head>
    ...
    <!-- CSS files -->
    <link href="{{ asset("./tabler/dist/css/tabler.rtl.css") }}" rel="stylesheet"/>
    <link href="{{ asset("./tabler/dist/css/tabler-flags.rtl.css") }}" rel="stylesheet"/>
    <link href="{{ asset("./tabler/dist/css/tabler-payments.rtl.css") }}" rel="stylesheet"/>
    <link href="{{ asset("./tabler/dist/css/tabler-vendors.rtl.css") }}" rel="stylesheet"/>
    <link href="{{ asset("./tabler/dist/css/demo.rtl.css") }}" rel="stylesheet"/>
    <style>
